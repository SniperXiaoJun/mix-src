...
//SM1
#define CKK_SM1						(CKK_VENDOR_DEFINED + 0x0B)
#define CKM_SM1_KEY_GEN				(CKM_VENDOR_DEFINED + 0x0B)
#define CKM_SM1_ECB					(CKM_VENDOR_DEFINED + 0x0C)
#define CKM_SM1_CBC					(CKM_VENDOR_DEFINED + 0x0D)
#define CKM_SM1_CBC_PAD				(CKM_VENDOR_DEFINED + 0x0E)
#define CKM_SM1_ECB_PAD				(CKM_VENDOR_DEFINED + 0x0F)

//SMS4
#define CKK_SMS4					(CKK_VENDOR_DEFINED + 0x11)
#define CKM_SMS4_KEY_GEN			(CKM_VENDOR_DEFINED + 0x11)
#define CKM_SMS4_ECB				(CKM_VENDOR_DEFINED + 0x12)
#define CKM_SMS4_CBC				(CKM_VENDOR_DEFINED + 0x13)
#define CKM_SMS4_CBC_PAD			(CKM_VENDOR_DEFINED + 0x14)
#define CKM_SMS4_ECB_PAD			(CKM_VENDOR_DEFINED + 0x15)
...
//SM3
#define CKM_SM3                     (CKM_VENDOR_DEFINED + CKM_MD5)
#define CKM_SM3_HMAC				(CKM_VENDOR_DEFINED + CKM_MD5_HMAC)
#define CKM_SM3_HMAC_GENERAL		(CKM_VENDOR_DEFINED + CKM_MD5_HMAC_GENERAL)
