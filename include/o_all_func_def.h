...
extern "C" {
	...
	*/
	COMMON_API unsigned long OPF_SM2GenCSR(OPT_HCONTAINER hContainer,
		const OPST_USERINFO *pstUserInfo,unsigned char * pbCSR, unsigned long * ulCSR);
	...
	*/
	COMMON_API unsigned long OPF_SM2SignCSR(OPT_HCONTAINER hContainer,
		...
		unsigned char * pbCSRSigned, unsigned long * ulCSRSignedLen);
	...
	*/
	COMMON_API unsigned long OPF_SM2SignCert(void * hSessionHandle,
		...
		unsigned char * pbX509CertSigned, unsigned long * ulX509CertSignedLen);
	...
	COMMON_API unsigned long OPF_SM2SignCRL(void * hSessionHandle,
		...
		unsigned char * pbCRLSigned, unsigned long * ulCRLSigned);


	// 二进制与HEX相互转换
	COMMON_API unsigned long OPF_Str2Bin(const char *pbIN,unsigned long ulIN,unsigned char *pbOUT,unsigned long * ulOUT);
	// 二进制与HEX相互转换
