...
void CContactMB_GRP::setupMenuBar(QMainWindow *CContact)
{
    ...
    actionNewEGrp->setText("新增非密组");

    actionGrpWrite = new QAction(CContact);
    actionGrpWrite->setText("群发非密信息");
    ...
    actionCopyTo->setText("复制至加密组");

	actionCutTo = new QAction(CContact);
    actionCutTo->setText("剪切至加密组");
